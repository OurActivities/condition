...
You can see the latest releases in the Github repository at https://github.com/OurActivities/condition/releases
...
```
@ouractivities/condition
```

Or go directly to https://www.npmjs.com/package/@ouractivities/condition

To install the node module package use the following:

```
$ npm i @ouractivities/condition
```
